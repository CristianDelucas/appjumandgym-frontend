...
import { AiOutlineMail, AiOutlineUser,AiOutlineCalendar,AiOutlineDashboard, AiOutlinePushpin } from "react-icons/ai";
    ...
    <form onSubmit={ handleSubmit(submit)} className='signup-form'>
                ...
                <div className='input-boxes'>
                    ...
                    <div className='input-box'>
                        ...
                        <input style={errors.nombre && {border:'2px solid red'}}
                            type="text"
                            placeholder="Nombre"
                            name="nombre"
                            {...register('nombre', {
                    ...
                    <div className='input-box'>
                        ...
                        <input style={errors.apellidos && {border:'2px solid red'}}
                    ...
                    <div className='input-box'>
                        <i className='fas fa-envelope'><HiOutlinePhone/></i>
                        <span className='title-input-box'>Móvil</span>
                        <input style={errors.movil && {border:'2px solid red'}}
                        type="tel" placeholder="Móvil" name='movil'
                        {...register('movil', {
                            required: { value: true, message: "'Móvil' es obligatorio" },
                            pattern: { value: /^[0-9\b]+$/,
                            message: "Sólo números"}
                            })}/>
                            {errors.movil && <span className='error-message'>{errors.movil.message}</span>}
                    </div>
                    ...
                    <div className='input-box radios'>
                        ...
                        <label>
                            <div>
                            <input type="radio" name="sexo" value="hombre" {...register("sexo",
                            {
                            required: { value: true, message: "Debe seleccionar un 'Sexo'" },
                            })} />
                                Hombre
                            </div>
                        </label>
                        <label>
                            <div>
                            <input type="radio" name="sexo" value="mujer" {...register("sexo",
                            {
                            required: { value: true, message: "Debe seleccionar un 'Sexo'" },
                            })} />
                            Mujer
                    ...
                    <span className='title-input-box'>Fecha de nacimiento</span>
                        <i className='fas fa-envelope'><AiOutlineCalendar/></i>
                        <input style={errors.fecha_nacimiento && {border:'2px solid red'}}
                    ...
                    <div className='input-box'>
                        ...
                        <i className='fas fa-envelope'><AiOutlineDashboard/></i>
                        <input style={errors.peso && {border:'2px solid red'}}
                        type="number" placeholder="Peso actual" name='peso' 
                        {...register('peso', {
                            required: { value: true, message: "'Peso actual' es obligatorio" },
                    ...
                    <div className='input-box'>
                        ...
                        <i className='fas fa-envelope'><AiOutlineDashboard/></i>
                        <input style={errors.altura && {border:'2px solid red'}}
                        type="number" placeholder="Altura" name='altura' 
                        {...register('altura', {
                            required: { value: true, message: "'Altura' es obligatorio" },
                            min: {value: 35, message:"Altura inválida"},
                            
                            })}/>
                        {errors.altura && <span className='error-message'>{errors.altura.message}</span>}
                    </div>
                    

                    <div className='input-box'>
                        <span className='title-input-box'>Objetivo deseado</span>
                        <i className='fas fa-envelope'><GiBodySwapping/></i>
                        <select name='objetivo' label='objetivo' style={errors.objetivo && {border:'2px solid red'}} {...register('objetivo', {
                        ...
                        {errors.objetivo && <span className='error-message'>{errors.objetivo.message}</span>}
                    </div>

                    <div className='input-box'>
                        <span className='title-input-box'>Actividad física</span>
                        <i className='fas fa-envelope'><GiBodySwapping/></i>
                        <select name='actividad' label='actividad' style={errors.actividad && {border:'2px solid red'}} {...register('actividad', {
                        ...
                        {errors.actividad && <span className='error-message'>{errors.actividad.message}</span>}
                    </div>
                    ...
                    <div className='input-box'>
                        ...
                        <i className='fas fa-envelope'><BiKey/></i>
                        <input style={errors.passwordrepetido && {border:'2px solid red'}}
                        type={show ? 'text':'password'} placeholder="Repite la contraseña" name='passwordrepetido'
                        {...register('passwordrepetido', {
                            required: { value: true, message: "'Contraseña' es obligatorio" },
                            })}/>
                        {show?<HiEyeOff onClick={()=> setShow(!show)} className='showpassword'/>:
                        <HiEye onClick={()=> setShow(!show)} className='showpassword'/>}
                        {errors.passwordrepetido && <span className='error-message'>{errors.passwordrepetido.message}</span>}
                    </div>
